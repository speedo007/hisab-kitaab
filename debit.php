...
.submenu {
  ...
  <input type="text" name="total" class="calculator-screen" value="" disabled />

  <div class="calculator-keys">

    <button type="button" class="operator" name= value="+">+</button>
    ...
    <button type="button" class="equal-sign operator" name="equal" value="=">=</button>
